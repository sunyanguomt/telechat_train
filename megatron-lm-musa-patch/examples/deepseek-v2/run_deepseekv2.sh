...
NUM_MICROBATCHES=${NUM_MICROBATCHES:-75}
...
set -u
  ...
  DATA_PATH=${DATA_PATH:-"/mnt/yanguo.sun/dianxin/bin_data_40/test_0"}
  HOSTFILE=./hostfile
  LOG_FILE=$WORK_HOME/output/$CURRENT_TIME/$EXPNAME.log
  TOKENIZED_MODEL=${TOKENIZED_MODEL:-"/mnt/yanguo.sun/dianxin/TeleChat3-36B-Thinking"}
  SCRIPT_FILE=./deepseek-v2-lite/run_pretrain_deepseekv2_musa_236B.sh
