...
#         self, config: TransformerConfig, model_comm_pgs: Optional[ProcessGroupCollection] = None
#     ) -> None:
#     """Initialize the zero token dropping router.

#     Args:
#         config (TransformerConfig): The configuration for the transformer model.
#         model_comm_pgs (ProcessGroupCollection, optional): Process groups for MoE operations.
#     """
